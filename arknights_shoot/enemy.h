...
public:
    enemy(float x, float y) : character(x, y, 64, 90) {
        // 初始化敌人资源（示例）
        resource_manage::get_instance().load_image("enemy_idle_right", "./res/chars/watcher1.png");
        resource_manage::get_instance().load_image("enemy_idle_left", "./res/chars/watcher1.png");
    }
